...
<!-- <section class = "home_section">
    <div class="section-header">
		...
		<div class="section-tagline">
            Affordable elegance with exclusive time-limited deals
		</div>					
	</div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                       Our dedicated support team is available 24/7 to assist you with bookings, vehicle issues, or road emergencies—anytime, anywhere.
                    </p>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                        Our team of certified experts keeps every vehicle in top shape using the latest tools and diagnostics for optimal performance and safety.
                    </p>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                        With countless satisfied customers, we are a trusted choice for eco-conscious and reliable car rentals, both short and long-term.
                    </p>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                       We’re proud of our glowing customer feedback—praised for clean vehicles, excellent service, and hassle-free rentals.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="footer_widget">
                    <a class="navbar-brand" href="">
                        L<span style = "color:">ux</span>&nbsp;CarRental
                    </a>
                    <p>
                        Getting dressed up and traveling with good friends makes for a shared, unforgettable experience.
                    </p>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="footer_widget">
                    ...
                    <ul class = "contact_info">
                        <li>
                            <i class="fas fa-map-marker-alt"></i>400 Kent Street, Sydney New South Wales 2000
                        </li>
                        <li>
                            <i class="far fa-envelope"></i>abc@luxcar.com
                        </li>
                        <li>
                            <i class="fas fa-mobile-alt"></i>+61 111 121 121
                        </li>
                    </ul>
                </div>
            </div>
